    ...
    <div className="mx-auto w-full max-w-xl text-2xl subpixel-antialiased">
      ...
      <div className="relative w-full mt-6">
        ...
        <input
          ...
          id="member_email"
        />
        <button className="absolute insety-y-0 top-2.5 right-2.5 py-2 px-3 rounded-md font-medium text-white bg-gradient-to-r from-orange-400 to-orange-600 text-sm">
          Get Notified!
        </button>
      </div>
    </div>
