    ...
    return (
        <>
            ...
            <main className="w-full flex flex-col items-center text-white py-12">
                <div className="w-[200px] h-[200px] bg-slate-700 flex justify-center items-center rounded-2xl border-[3px] border-slate-200 shadow-md">image</div>
                ...
                <div className="py-10 px-10 bg-slate-900 rounded-2xl w-[50%]">
                    <span className="text-[20px]">Account Information</span>
                    <span className="block text-[12px] text-slate-300  mt-1 mb-5">Here you can view and edit your account information </span>
                    <div className="grid grid-cols-2 gap-y-10 mb-5">
                        <div>
                            <span className="text-[16px] text-slate-400">Full Name</span>
                            <br />
                            <div className="w-[90%] h-[65px] bg-slate-800 mt-4 rounded-xl flex items-center px-5 text-slate-100 text-[15px]">Dipzin Member</div>
                        </div>
                        <div>
                            <span className="text-[16px] text-slate-400">Username</span>
                            <br />
                            <div className="w-[90%] h-[65px] bg-slate-800 mt-4 rounded-xl flex items-center px-5 text-slate-100 text-[15px]">@dipzinmember</div>
                        </div>
                        <div>
                            <span className="text-[16px] text-slate-400">Email Address</span>
                            <br />
                            <div className="w-[90%] h-[65px] bg-slate-800 mt-4 rounded-xl flex items-center px-5 text-slate-100 text-[15px]">ahmedumahmoud@gmail.com</div>
                        </div>
                        <div>
                            <span className="text-[16px] text-slate-400">Role</span>
                            <br />
                            <div className="w-[90%] h-[65px] bg-slate-800 mt-4 rounded-xl flex items-center px-5 text-slate-100 text-[15px]">Product Designer</div>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <br />
                            <div className="w-[90%] h-[65px] bg-slate-800 mt-4 rounded-xl flex items-center px-5 text-slate-100 text-[15px]">United States</div>
                        </div>
                    </div>
                </div>
            </main>
