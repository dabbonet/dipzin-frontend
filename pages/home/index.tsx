                    ...
                    <div className="flex justify-center items-center relative">
                        <div className="rounded-2xl overflow-hidden min-720:gap-16 transform transition duration-500 hover:scale-105">
                            ...
                            <div className="absolute w-[100%] top-4 flex justify-center drop-shadow-xl">
                                <img className=" transform transition duration-500 hover:scale-110 cursor-pointer" src="/images/assets/addpng.svg" />
                                <img className=" transform transition duration-500 hover:scale-110 cursor-pointer" src="/images/assets/addcopy.svg" />
                                <img className=" transform transition duration-500 hover:scale-110 cursor-pointer" src="/images/assets/addcollection.svg" />
                            </div>
                            <div className="absolute w-[100%] bottom-5 flex justify-start drop-shadow-xl px-4">
                                <img src="/images/assets/appicon.svg" />
                                ...
                                <img className="ml-auto" src="/images/assets/screenzome.svg" />
