...
const Screen = ({ src }: ScreenProps) => {
  return (
    <div className="flex justify-center items-center relative group/item">
      <div className="rounded-2xl overflow-hidden min-720:gap-16 transform-gpu transition duration-500 hover:scale-105">
        <img
        ...
        {/*
                ...
                */}
        <div className="absolute w-[100%] bottom-3 flex justify-start items-center drop-shadow-xl opacity-0  transform-gpu transition duration-500 group-hover/item:opacity-100 z-20">
          <img
        ...
        <div className="absolute bottom-0 w-[100%] h-[30%] bg-gradient-to-t from-black opacity-80 z-10 invisible transform-gpu transition duration-500 group-hover/item:visible"></div>
      </div>
    </div>
  );
};
