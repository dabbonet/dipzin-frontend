const CollectionSideNavigator = () => {
  return (
    <div className="fixed right-10 top-[45%] md:hidden lg:w-[100px] xl:w-[110px] xxl:w-[130px] h-auto space-y-2 py-2 px-2 bg-slate-900/30 border border-slate-800 rounded-2xl flex flex-col justify-between">
      <a
        href="#"
        className="flex-grow-0 flex-shrink-0 w-full lg:h-[80px] xl:h-[80px] xxl:h-[90px] relative m-auto rounded-xl bg-slate-800 border-[2.5px] border-transparent hover:border-slate-700 cursor-pointer focus:border-orange-500"
      >
