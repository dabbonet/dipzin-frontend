        ...
        <div className='flex space-x-4 mt-2 h-[90%] '>
            ...
            <div className='w-[70%] max-w-[1000px]'>
                <div className='flex items-center text-sm mb-2'>
                     <p className='uppercase flex-1 text-slate-400'>Coming Soon</p>
                     <ul className='inline-flex space-x-2 text-xs'>
                        <li><Link href={''} className='text-slate-400 hover:text-slate-200'>Privacy</Link></li>
                        <li><Link href={''} className='text-slate-400 hover:text-slate-200'>Terms of Service</Link></li>
                        <li><Link href={''} className='text-slate-400 hover:text-slate-200'>Copyrights</Link></li>
                     </ul>
                     <SocialActions />
                </div>
