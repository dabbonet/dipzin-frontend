...
const WebHoverScreen = ({ images, app }: HoverScreenProps) => {
...
const WebSingleScreen = ({ image }: SingleScreenProps) => {
    ...
    <div className="flex justify-center items-center relative group/item">
      ...
      >
        ...
        <div className="w-full rounded-2xl overflow-hidden min-720:gap-16 ">
          <BlurImage platform={4} src={image} />
        </div>
      </motion.div>
    </div>
  );
...
export { WebHoverScreen, WebSingleScreen };
