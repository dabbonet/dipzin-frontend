...
const soonItems = [
  { heading: 'Marketing Pages', description: "Showcases your brand's offerings effectively.", badge: 'Q2 2024' },
  { heading: 'Arabic Marketing Pages', description: 'Easily collect your Arabic marketing pages.', badge: 'Q2 2024' },
  { heading: 'Collections', description: 'Create, share, comment, and save in your collection library.', badge: 'Q3 2024' },
  { heading: 'Flows', description: 'See the flow screens of web and apps.', badge: 'Q3 2024' },
  { heading: 'Interactive Prototypes', description: 'Interact with prototype screens all in one place.', badge: 'Q3 2024' },
  { heading: 'Journey Interactions', description: 'View Flow Interactions, Gestures and Collect it.', badge: 'Q3 2024' },
  { heading: 'Figma Plugin', description: 'Easily download screens with Figma Plugin.', badge: 'Q4 2024' },
  { heading: 'Mobile Apps', description: 'Available for download as a mobile app.', badge: 'Q4 2024' },
  { heading: '+1000 Apps', description: 'Over 1000 apps available in one place.', badge: 'Q4 2024' },
  { heading: 'Comments', description: 'Leave comments in your collection.', badge: 'Q4 2024' },
];
          ...
          <div className="mt-4 w-full h-fit flex p-0 items-center justify-between">
            ...
            <CommandGroup>
              <CommandItem className="flex items-center gap-2 text-sm text-gray-500 p-0">
                <Link href="/legal/terms" className="text-slate-500 hover:text-aqua-500 transition-all font-medium text-[10px]">Copyrights</Link>
                <Link href="/legal/term-of-service" className="text-slate-500 hover:text-aqua-500 transition-all font-medium text-[10px]">Terms of Service</Link>
                <Link href="/legal/privacy-policy" className="text-slate-500 hover:text-aqua-500 transition-all font-medium text-[10px]">Privacy</Link>
              </CommandItem>
            </CommandGroup>
          </div>
        </CommandGroup>
        ...
        <DrawerContent className="h-screen w-screen bg-slate-950 rounded-none border-0">
          ...
          <DrawerFooter>
            <DrawerClose onClick={() => setIsDrawerOpen(false)} asChild>
              <Button isIconOnly variant="darkGray"><ChevronRightIcon className="size-4" /></Button>
            </DrawerClose>
          </DrawerFooter>
        </DrawerContent>
      </Drawer>
