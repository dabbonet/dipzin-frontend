...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-semibold transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none shadow-button",
  {
    variants: {
      variant: {
        default:
          "bg-gradient-to-b from-aqua-400 to-aqua-600 text-primary-foreground ring-aqua-700 hover:to-aqua-800 active:ring-2 active:hover:to-aqua-600 disabled:from-gray-500 disabled:to-gray-600",
        secondary:
          "bg-secondary text-secondary-foreground ring-aqua-900 hover:bg-aqua-900 active:ring-2 active:hover:bg-secondary disabled:bg-gray-800 disabled:text-gray-700",
        strocked:
          "border border-aqua-400 bg-slate-950 text-white hover:bg-slate-900 active:bg-gradient-to-b active:from-[#020617] active:to-[#0F172A] active:hover:bg-slate-950 disabled:border-gray-700 disabled:bg-gray-800 disabled:text-gray-700",
