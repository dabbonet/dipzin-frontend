...
const UserData = () => {
  ...
  return (
    user && (
      <div className=" flex flex-col relative gap-y-1" ref={wrapperRef}>
        <AnimatePresence mode="wait">{show && <Menu />}</AnimatePresence>
        <Popover placement="top">
          ...
          <PopoverContent className=" flex flex-col gap-3 bg-slate-900 p-4 -z-50">
            <button
              onClick={onOpen}
              className=" flex gap-1 w-full bg-transparent hover:bg-slate-700 px-3 py-2 rounded-lg text-slate-50 items-center"
            >
              <Icons.Account />
              ...
              return (
                <>
                  ...
                  <ModalBody>
                    <Tabs
                      variant="bordered"
                      className="rounded-2xl w-fit ml-auto border-slate-500"
                      classNames={{
                        tabList: "bg-transparent border-slate-500",
                        cursor: "dark:bg-slate-700 bg-slate-700",
                      }}
                    >
                      <Tab
                          ...
                          <CardBody className=" bg-transparent hover:bg-transparent drop-shadow-none p-0">
                            <form className="bg-slate-900 bg-opacity-50 mt-2 rounded-2xl w-full grid gap-4 md:grid-cols-2 grid-cols-1">
                              ...
                              <div className="flex gap-4 mt-4 mb-4">
                                ...
                                <div className="flex flex-col justify-center">
                                  ...
                                  <p className=" text-slate-600 text-sm">
                                    Supported formats: jpg, png maximum size:
                                    2MB
                                  </p>
                                </div>
                              </div>
                              <div className="">
                                <label
                                  htmlFor="name"
                                  className="block mb-2 text-sm font-normal text-gray-900 dark:text-slate-400"
                                >
                                  full name
                                </label>
                                <input
                              ...
                              <div className="">
                                ...
                                <input
                                  ...
                                  onChange={(e) => handleChange(e)}
                                  disabled={
                                    ![null, ""].includes(userDetails.username)
                                  }
                                />
                              </div>
                              <div className="">
                  ...
                  <ModalFooter className=" flex justify-between">
                    ...
                    <Button
                      className="text-aqua-950 bg-gradient-to-r from-aqua-400 to-aqua-600"
                      onPress={submitForm}
                    >
                      Save Updates
                    </Button>
