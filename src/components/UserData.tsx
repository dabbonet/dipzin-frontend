...
import { Button, Card, CardBody, Modal, ModalBody, ModalContent, ModalFooter, ModalHeader, Popover, PopoverContent, PopoverTrigger, Tab, Tabs, User, useDisclosure } from '@nextui-org/react'
...
const UserData = () => {
  ...
  return (
    user && <div className=' flex flex-col relative gap-y-1' ref={wrapperRef}>
      ...
      <Modal isOpen={isOpen} onOpenChange={onOpenChange} className=' bg-slate-900 p-5' size='4xl' isDismissable={false} backdrop='blur'>
        <ModalContent>
          {(onClose) => {
              ...
              <>
                ...
                <ModalBody>
                  <Tabs variant='bordered' className='rounded-2xl w-fit ml-auto border-slate-500' classNames={{ tabList: 'bg-transparent border-slate-500', cursor: 'dark:bg-slate-700 bg-slate-700' }}>
                    <Tab className=' bg-transparent hover:bg-transparent' key='Account setup' title='Account setup'>
