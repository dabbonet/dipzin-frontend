    ...
    return (
        <div ref={wrapperRef} className="fixed left-0 right-0 bottom-12 max-w-[80%] mx-auto flex justify-center z-20">
            <motion.div layoutRoot className='relative flex items-end'>
                ...
                <motion.div
                    className="relative w-full bg-slate-900/90 border-[0.5px] border-slate-800 p-2 flex-col items-end text-slate-100 tracking-[.07rem]"
                    transition={{ type: "spring", duration: 0.6, delay: 0.1 }}
                    initial={{ borderRadius: 30, boxSizing: "border-box", origin: "center" }}
                >
                    {navOpen && !menuOpen && (
                    ...
                    <motion.div className="flex">
                        <motion.div
                            layout
                            className="flex items-center bg-slate-800 hover:bg-slate-700 cursor-pointer rounded-3xl px-7 space-x-2 mr-5 h-[48px]"
                            onClick={() => {
