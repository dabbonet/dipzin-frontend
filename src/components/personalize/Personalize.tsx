          ...
          <div className=" mt-9">
            ...
            <div className=" flex justify-between items-center">
              ...
              <div className=" flex items-center gap-4">
                <Link
                  href="/profile/profile-informations"
                  className=" py-3 px-9 bg-slate-800 text-slate-500 rounded-lg"
                >
                  Back
                </Link>
                <button
                  onClick={handleAllSet}
                  className=" py-3 px-9 bg-gradient-to-tr from-aqua-400 bg-aqua-600 text-aqua-950 font-medium rounded-lg"
                >
                  Next
                </button>
              </div>
