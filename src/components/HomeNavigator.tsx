    ...
    return (
        <div className="flex space-x-6 items-center mt-8 h-10">
            <Link href="/" className="cursor-pointer duration-500 flex items-center">
                <span
                    className={cn("text-slate-900 dark:text-slate-100 text-[2rem] font-light origin-left transform transition-all duration-500", path === "/" ? "text-[2.2rem] opacity-100" : "opacity-70")}
                >
                    Stream
                </span>
                <motion.div
