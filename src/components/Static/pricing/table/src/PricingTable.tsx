      ...
      <TableBody>
        ...
        {features.map((feature) => (
          <TableRow key={feature.name}>
            <TableCell className="w-1/4 py-5 px-2 text-lg font-medium">{feature.name}</TableCell>
            <TableCell className="w-1/4">{renderCellContent(feature.free)}</TableCell>
            <TableCell className="w-1/4">{renderCellContent(feature.personal)}</TableCell>
            <TableCell className="w-1/4">{renderCellContent(feature.team)}</TableCell>
          </TableRow>
        ))}
      </TableBody>
    </Table>
