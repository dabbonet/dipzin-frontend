const Background = () => {
    return (
        <div className='fixed top-0 -z-10 w-full h-full overflow-hidden'>
            ...
            {/* Blur Shape */}
            <svg className="fixed bottom-0 right-0 -z-20 opacity-[0.2] dark:opacity-[0.25] text-blue-500 dark:text-blue-800" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 600" version="1.1">
                <defs>
