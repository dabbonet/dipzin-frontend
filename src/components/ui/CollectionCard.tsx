    ...
    <div className=" bg-slate-800 p-4 border-solid border border-slate-700 rounded-3xl">
      <div className=" grid grid-cols-3 gap-3">
        <div className=" overflow-hidden rounded-lg">
          <img src="/images/assets/collection-screen2.svg" alt="" className=" w-full h-full object-cover" />
        </div>
        <div className=" overflow-hidden rounded-lg">
          <img src="/images/assets/collection-screen1.svg" alt="" className=" w-full h-full object-cover" />
        </div>
        <CollectionApps/>
      </div>
...
const ShowCardLinksUI = ({ clicked }) => {
  if (clicked) { 
    return <div className="px-4 py-5 bg-slate-900 rounded-2xl absolute -top-60 -left-52 flex flex-col w-60">
...
const CollectionApps = () => {
  return <div className=" flex flex-col gap-3 items-center justify-between">
    <div className=" flex-1">
      <img src="/images/assets/collection-app1.svg" alt="" className=" w-full h-full object-cover" />
    </div>
    <div className=" flex-1">
      <img src="/images/assets/collection-app2.svg" alt="" className="w-full h-full object-cover" />
    </div>
    <div className=" flex-1">
      <img src="/images/assets/collection-app3.svg" alt="" className="w-full h-full object-cover" />
    </div>
</div>
}