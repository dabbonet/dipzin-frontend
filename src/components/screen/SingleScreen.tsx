    ...
    >
      ...
      >
        <motion.div
          ...
          className={cn(
            "absolute top-5 left-5 group/copy border-[3px] border-slate-200 w-7 h-7 z-40 rounded-md flex items-center justify-center cursor-pointer invisible group-hover/item:visible",
