    ...
    return (
        <div
            className={cn(
                ...
                selected === 3 ? "2xl:grid-cols-3 md:grid-cols-3" : " 2xl:grid-cols-5 lg:grid-cols-4 md:grid-cols-3",
                )}
        ...
        >
            ...
            <div className={cn('bg-slate-900/60 backdrop-blur-2xl col-span-1 rounded-3xl flex justify-center items-center w-full h-full')}><Icons.Image className='text-slate-800 h-16 w-16' /></div>
            <div className={cn('bg-slate-900/60 backdrop-blur-2xl col-span-1 rounded-3xl flex justify-center items-center w-full h-full')}><Icons.Image className='text-slate-800 h-16 w-16' /></div>
            <div className={cn('bg-slate-900/60 backdrop-blur-2xl col-span-1 rounded-3xl flex justify-center items-center w-full h-full')}><Icons.Image className='text-slate-800 h-16 w-16' /></div>
            <div className={cn('bg-slate-900/60 backdrop-blur-2xl col-span-1 rounded-3xl flex justify-center items-center w-full h-full')}><Icons.Image className='text-slate-800 h-16 w-16' /></div>
            <div className={cn('bg-slate-900/60 backdrop-blur-2xl col-span-1 rounded-3xl flex justify-center items-center w-full h-full')}><Icons.Image className='text-slate-800 h-16 w-16' /></div>
