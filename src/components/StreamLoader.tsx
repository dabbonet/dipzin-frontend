...
export default function StreamLoader() {
    ...
    return (
        ...
        >
            ...
            <div className='bg-slate-900/60 backdrop-blur-2xl col-span-1 h-[550px] rounded-3xl flex justify-center items-center'><Icons.Image className='text-slate-800 h-16 w-16' /></div>
            <div className='bg-slate-900/60 backdrop-blur-2xl col-span-1 h-[550px] rounded-3xl flex justify-center items-center'><Icons.Image className='text-slate-800 h-16 w-16' /></div>
            <div className='bg-slate-900/60 backdrop-blur-2xl col-span-1 h-[550px] rounded-3xl flex justify-center items-center'><Icons.Image className='text-slate-800 h-16 w-16' /></div>
            <div className='bg-slate-900/60 backdrop-blur-2xl col-span-1 h-[550px] rounded-3xl flex justify-center items-center'><Icons.Image className='text-slate-800 h-16 w-16' /></div>
            <div className='bg-slate-900/60 backdrop-blur-2xl col-span-1 h-[550px] rounded-3xl flex justify-center items-center'><Icons.Image className='text-slate-800 h-16 w-16' /></div>
