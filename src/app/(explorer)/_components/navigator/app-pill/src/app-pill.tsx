...
import { extractInitials, snakeCaseToWords } from '@/utils/StringUtils';
  ...
  return (
    <TooltipProvider>
      <Tooltip delayDuration={0}>
        ...
        {data.neglected && data.reason && (
          <TooltipContent className="flex items-center justify-center gap-1 text-white p-2 rounded-lg sm:rounded-2xl">
            {snakeCaseToWords(data.reason)}
