                ...
                <div className="mx-auto w-full max-w-xl subpixel-antialiased">
                    ...
                    <div className=" w-full mt-6">
                        <div className="relative items-center pl-3 w-full p-3 rounded-lg gap-3">
                            ...
                            <button className="bg-aqua-500 hover:bg-aqua-300 text-aqua-900 text-sm font-semibold absolute top-[26%] right-5 py-2 px-3 rounded-lg cursor-pointer" onClick={(e) => submitEmail(e)}>Get Notified!</button>
                        </div>
