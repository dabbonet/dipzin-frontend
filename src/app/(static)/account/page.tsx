    ...
    <div className="max-w-7xl mx-auto tracking-wide">
      ...
      <div className="flex justify-between mt-12 items-center flex-wrap gap-y-3">
        <div className="flex items-center space-x-8 flex-wrap gap-y-3">
          <div className="bg-slate-700 w-28 h-28 rounded-2xl mx-auto md:mx-0"></div>
          <div>
        ...
        <ActionBar className="h-fit mx-auto md:mx-0">
      ...
      <div className="bg-slate-900 bg-opacity-50 mt-8 rounded-2xl w-full grid gap-4 px-8 py-8 md:grid-cols-2 grid-cols-1">
        <div className="">
          <label className="block mb-2 text-sm font-normal text-gray-900 dark:text-slate-400">
            First name
          </label>
          <input
            type="text"
